...
本代码为神代綺凜(https://moe.best)原创，Wibus(https://blog.iucky.cn)魔改，并遵守 GPL 2.0 开源协议。
...
function setCopyright(type) {
    // 页脚添加版权信息 '&nbsp;|&nbsp;Theme modified by <a href="https://blog.iucky.cn" target="_blank">Wibus&JindaiKirin</a>&nbsp;|&nbsp;'

    var badgeInfo = '&nbsp;|&nbsp; \n' +
        '<div class="github-badge">\n' +
        '    <a href="https://blog.iucky.cn" target="_blank" title="handsome主题由wibus & JindaiKirin魔改">\n' +
        '        <span class="badge-subject">Modified</span><span class="badge-value bg-red">Wibus & JindaiKirin</span>\n' +
        '    </a>\n' +
        '</div>' +
        '&nbsp;&nbsp; \n';

    var textInfo = '&nbsp;|&nbsp; \n' +
        '    <a href="https://blog.iucky.cn" target="_blank" title="hhandsome主题由wibus & JindaiKirin魔改">\n' +
        '        Modified&nbsp;&nbsp;Wibus\n' +
        '    </a>\n';
    '&nbsp;&nbsp; \n';
